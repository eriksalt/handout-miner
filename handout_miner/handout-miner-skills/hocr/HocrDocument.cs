...
namespace handout_miner_skills.hocr
{
    ...
    public class HocrPage
    {
        ...
        public IEnumerable<IEnumerable<NormalizedWord>> BuildOrderedWordGroupsFromBoundingBoxes(List<NormalizedLine> lines, List<NormalizedWord> words)
        {
